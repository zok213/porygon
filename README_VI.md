...
- **Mô Phỏng Tự Chứa (Zero-Dependency ModelSim Simulation)**: Tích hợp sẵn thư viện linh kiện Gowin ([`FPGA/src/prim_sim.v`](FPGA/src/prim_sim.v)), kịch bản chạy 1 lệnh [`FPGA/run_sim.do`](FPGA/run_sim.do), và Testbench tự động kiểm thử 25 chỉ tiêu (`25 checks, 0 errors`) chứng minh chu kỳ thở $2.000000\text{ s}$ trên ModelSim.

> 📖 **Tài liệu Hướng dẫn Mô phỏng Chuyên sâu**:
> - 🌊 [Hướng dẫn Mô phỏng ModelSim FPGA Toàn diện](FPGA/README_MODELSIM_SIMULATION.md)
