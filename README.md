...
> 🇻🇳 [Tiếng Việt — Bản Thuyết Minh Định Hướng & Tổng Quan Hệ Thống](#-bản-thuyết-minh-định-hướng--tổng-quan-hệ-thống-tiếng-việt)  
...
Hệ thống mã nguồn được phân tách độc lập và quản trị theo mô hình **Git Flow Đa Nhánh (Multi-Track Branch Architecture)**:
